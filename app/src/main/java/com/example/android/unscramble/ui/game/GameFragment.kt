...
class GameFragment : Fragment() {
    //    TODO 3 associate a ViewModel to a UI controller
    ...
    */
    ...
    private fun showFinalScoreDialog(){
        MaterialAlertDialogBuilder(requireContext())
            ...
            .setCancelable(false) // can't be cancel if click back button
/*        setNegativeButton(getString(R.string.exit),
                                      { _, _ -> exitGame()})
                the shorten version is below
                ...
                This is known as trailing lambda syntax. Both ways of writing the code
                (with the lambda inside or outside the parentheses) is acceptable  */
